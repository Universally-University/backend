!(function (t, e) {
                ...
                (this.bodyUsed = this.bodyUsed),
                    ...
                    t
                        ? "string" == typeof t
                            ...
                            : r.arrayBuffer && (ArrayBuffer.prototype.isPrototypeOf(t) || n(t))
    ...
    function l(t, e) {
        ...
        if (
            ...
            (this.method = ((r = e.method || this.method || "GET"), (o = r.toUpperCase()), p.indexOf(o) > -1 ? o : r)),
    ...
    (l.prototype.clone = function () {
        ...
        (m.prototype.clone = function () {
            return new m(this._bodyInit, { status: this.status, statusText: this.statusText, headers: new h(this.headers), url: this.url });
        }),
        (m.error = function () {
    ...
    function v(o, n) {
        return new Promise(function (i, a) {
            var f = new l(o, n);
            if (f.signal && f.signal.aborted) return a(new t.DOMException("Aborted", "AbortError"));
            ...
            (u.onload = function () {
                ...
                "responseType" in u && (r.blob ? (u.responseType = "blob") : r.arrayBuffer && f.headers.get("Content-Type") && -1 !== f.headers.get("Content-Type").indexOf("application/octet-stream") && (u.responseType = "arraybuffer")),
    ...
    (v.polyfill = !0), e.fetch || ((e.fetch = v), (e.Headers = h), (e.Request = l), (e.Response = m)), (t.Headers = h), (t.Request = l), (t.Response = m), (t.fetch = v), Object.defineProperty(t, "__esModule", { value: !0 });
});
